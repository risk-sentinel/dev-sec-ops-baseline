...
| **group_governance**<br>Group-inherited merge rules | `GET /repos/{owner}/{repo}/rulesets (parent rulesets included)`<br>[docs](https://docs.github.com/en/rest/repos/rules) | `GET /groups/{id}/protected_branches`<br>[docs](https://docs.gitlab.com/api/group_protected_branches/) | &mdash; |
| **security_policy_project**<br>Merge rules held in a separate policy project | &mdash; | `GraphQL project.securityPolicyProject, then GET /projects/{policy_id}/repository/files/.gitlab%2Fsecurity-policies%2Fpolicy.yml/raw`<br>[docs](https://docs.gitlab.com/user/application_security/policies/merge_request_approval_policies/) | &mdash; |
